...
**选择区域**的使用场景有限，一般用于富文本编辑类业务，我们不做深入讨论；**DOM 事件**有一定的关联性，将下篇文章中详细讨论；对于**DOM节点**，需与另外两个概念标签和元素进行区分：
...
```
![Image text](https://s0.lgstatic.com/i/image/M00/09/03/CgqCHl67pcyAWvv3AAApkJ2_V24631.png)
...
![Image text](https://s0.lgstatic.com/i/image/M00/09/04/Ciqc1F67pdqAS3FFAAAmGZWHWDs688.png)
...
```
![Image text](https://s0.lgstatic.com/i/image/M00/09/04/CgqCHl67pemAQjkLAAAk8lHks5c377.png)
...
![Image text](https://s0.lgstatic.com/i/image/M00/09/04/Ciqc1F67piqAR40eAAAkNcoz7jY032.png)
...
```
![Image text](https://s0.lgstatic.com/i/image/M00/09/04/Ciqc1F67pjKAIKXfAAAlxYMHz74357.png)
...
```
![Image text](https://s0.lgstatic.com/i/image/M00/09/04/Ciqc1F67pjmAKJrEAAAjr0DG628141.png)
